...
namespace NexusHighlight.Commands
{
    internal static class CreateEditRule
    {
        ...
        public static void Initialize(VsPackage pkg, IMenuCommandService svc)
        {
            ...
            {
                var foregroundCommandId = new CommandID(PackageGuids.guidNexusHighlightPackageCmdSet, PackageIds.CreateEditForegroundRule);
                ...
                var backgroundCommandId = new CommandID(PackageGuids.guidNexusHighlightPackageCmdSet, PackageIds.CreateEditBackgroundRule);
