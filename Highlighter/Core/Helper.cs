...
namespace Highlighter.Core
{
    public static class Helper
    {
        ...
        public static List<Color> SetupColors(this List<Color> colors)
        {
            ...
            //# preset tag colors (used in GetFillerTags)
